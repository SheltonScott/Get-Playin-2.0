...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        /*
         Test creating a character using the Character class.
         Test to ensure that all Character properties are
         working properly.
         */
//        let newCharacter = Character()
//        print("Character name = \(newCharacter.characterName)")
//        print("Character race = \(newCharacter.characterRace)")
//        print("Character class = \(newCharacter.characterClass)")
//        print("Character level = \(newCharacter.characterLevel)")
//        print("Character strength = \(newCharacter.characterStrength)")
//        print("Character strength mod = \(newCharacter.strengthModifier)")
//        print("Character HP = \(newCharacter.characterHP)")
//        print("Character proficiency bonus = \(newCharacter.characterProficiencyBonus)")
    }
...
class Character {
    ...
    /*
     ...
     As Chad changes the character level, the proficiency bonus will change.
     */
